...
class wav2letter_torch_test(nn.Module): # 11 layer
    def __init__(self):
        
        super(wav2letter_torch_test, self).__init__()
        self.conv1 = nn.Conv1d(project_vars.base_channels * 3, 250, 48, 2, padding = 23)
        self.conv2 = nn.Conv1d(250, 250, 7, padding = 3)
        self.conv3 = nn.Conv1d(250, 250, 7, padding = 3)
        self.conv4 = nn.Conv1d(250, 250, 7, padding = 3)
        ...
        self.conv9 = nn.Conv1d(250, 2000, 32, padding = 15)
        self.conv10 = nn.Conv1d(2000, 2000, 1)
        self.conv11 = nn.Conv1d(2000, 29, 1)
    ...
    def forward(self, x):
        ...
        x = nn.functional.relu(self.conv9(x))
        x = nn.functional.relu(self.conv10(x))
        x = nn.functional.log_softmax(nn.functional.relu(self.conv11(x)), dim = 1)
        
        return x
    
class wav2letter_torch_test2(nn.Module): # 12 layer
    def __init__(self):
        
        super(wav2letter_torch_test2, self).__init__()
        self.conv1 = nn.Conv1d(project_vars.base_channels * 3, 250, 48, 2, padding = 23)
        self.conv2 = nn.Conv1d(250, 250, 7, padding = 3)
        self.conv3 = nn.Conv1d(250, 250, 7, padding = 3)
        self.conv4 = nn.Conv1d(250, 250, 7, padding = 3)
    ...
    def forward(self, x):
        ...
        x = nn.functional.relu(self.conv10(x))
        x = nn.functional.relu(self.conv11(x))
        x = nn.functional.log_softmax(nn.functional.relu(self.conv12(x)), dim = 1)
...
class wav2phoneme_torch_12(nn.Module): # 12 layer
    def __init__(self):
        
        super(wav2phoneme_torch_12, self).__init__()
        self.conv1 = nn.Conv1d(project_vars.base_channels * 3, 250, 48, 2, padding = 23)
        self.conv2 = nn.Conv1d(250, 250, 7, padding = 3)
        self.conv3 = nn.Conv1d(250, 250, 7, padding = 3)
        self.conv4 = nn.Conv1d(250, 250, 7, padding = 3)
...
class wav2phoneme_torch_12_80(nn.Module): # 12 layer
    def __init__(self):
        
        super(wav2phoneme_torch_12_80, self).__init__()
        self.conv1 = nn.Conv1d(project_vars.base_channels * 3, 250, 48, 2, padding = 23)
        self.conv2 = nn.Conv1d(250, 250, 7, padding = 3)
        self.conv3 = nn.Conv1d(250, 250, 7, padding = 3)
        self.conv4 = nn.Conv1d(250, 250, 7, padding = 3)
        ...
        self.conv9 = nn.Conv1d(250, 2000, 32, padding = 15)
        self.conv10 = nn.Conv1d(2000, 2000, 1)
        self.conv11 = nn.Conv1d(2000, 80, 1)
        self.conv12 = nn.Conv1d(80, 41, 1)
